...
let products = [
    { 
        name: "Red shoes", 
        price: 'Rs. 1499', 
        path: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c2hvZXN8ZW58MHx8MHx8fDA%3D", 
        title: 'red shoes', 
        slug: 'red-shoes'
    },
    { name: "white shoes", 
...
app.get('/products/:slug', (req, res) => {
    //res.end('m')
    const pro=products.find(p=>p.slug===req.params.slug)
